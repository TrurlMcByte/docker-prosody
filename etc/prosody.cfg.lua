...
admins = { "specialadminuser@example.com" }

-- Enable use of libevent for better performance under high load
-- For more information see: http://prosody.im/doc/libevent
use_libevent = true;

plugin_paths = { "/usr/lib/prosody/modules", "/etc/prosody/prosody-modules" };
...
modules_enabled = {
	...
	-- These are commented by default as they have a performance impact
		...
		-- "blocklist"; -- Support privacy lists in 0.10
...
welcome_message = "$host accepts you $user. За вами уже выехали."
...
log = {
	...
	-- debug = "*console"; -- Change 'info' to 'debug' for verbose logging
	-- error = "*console";
...
--     feeds = { goha_ru = "http://www.goha.ru/feed/0/rss"; }
